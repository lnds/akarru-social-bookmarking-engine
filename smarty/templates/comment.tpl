...
{#position_label#}
<input type="radio" class="view-input-class" name="position" id="position" value="1">apoyo</input>
<input type="radio" class="view-input-class" name="position" id="position" value="-2">en contra</input>
<input type="radio" class="view-input-class" name="position" id="position" value="-1">no apoyo</input>
