...
<tr><td><input type="text" disabled="disabled" name="email" class="view-input-class" size="30" value="{$email}" /></td></tr>
{if $error_cant_send_validation_link}
<tr><td class="error">{#error_cant_send_validation_link#}</td></tr>
{/if}
<tr><td><input type="submit" name="send_validation_link_code" value="{#label_send_validation_code#}" />
</table>
