...
<p>{#admin_categories_explanation#}
<br /><a href="admin_category.php">{#add_a_category_label#}</a>
</p>

<table border="0" cellspacing="0"cellpadding="0">
<tr><td>Category&nbsp;</td><td>#Memes&nbsp;</td><td>State&nbsp;</td><td>Toggle&nbsp;</td><td>Delete&nbsp;</td><td>Edit&nbsp;</td></tr>
{foreach from=$bm_cats item=cat}
<tr bgcolor="{cycle values="#ffffff,#efefef"}"><td><a href="show_cat.php?cat_id={$cat->ID}">{$cat->cat_title}</a></td><td align="right">{$cat->post_count}</td>
...
<td><a href="admin_category.php?cat_id={$cat->ID}" title="Edit {$cat->cat_title}"><img src="styles/img/edit.gif" style="border:0px" width="16" height="16" /></td></tr>
{/foreach}
</table>