...
<tr><td><input type="text" id="cat_name" name="cat_name" value="{$cat_name}" class="view-input-class" size="60" /></td></tr>
...
<tr><td><input type="text" id="cat_description" name="cat_description" value="{$cat_description}" class="view-input-class" size="60" /></td></tr>
<tr><td><input type="hidden" id="cat_id" name="cat_id" value="{$cat_id}" /><input type="submit" id="do_category_edit" name="do_category_edit" value="{#label_category_edit#}" /></td></tr>
