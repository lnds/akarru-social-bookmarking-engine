...
<table width="440" border="0" cellspacing="0" cellpadding="2" >
  ...
  <tr><td colspan="3"><div style="padding-left:1em" class="meme-footer-class"> 
  {if $logged_userid == 1}<a href="/edit-meme/{$meme->ID}">{#edit_meme_labell#}</a>{/if}</div> 
  </td></tr>
  {/if}
</table>
</div>